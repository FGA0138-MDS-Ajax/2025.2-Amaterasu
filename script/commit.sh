...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/CloudQuickLabsADO/_git/2025.2-AMATERASU.git
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/CloudQuickLabsADO/_git/2025.2-AMATERASU.git