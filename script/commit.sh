...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/mds-amaterasu-2025-2/_git/UnB%20Safe%20Zone
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/mds-amaterasu-2025-2/_git/UnB%20Safe%20Zone